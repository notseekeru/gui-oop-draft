...
// This is a common pattern when using jpackage(our packaging tool), as it allows for better separation of concerns and can help avoid issues with class loading or other complexities that may arise when jpackage tries to launch the application directly from the main class.
package main;
